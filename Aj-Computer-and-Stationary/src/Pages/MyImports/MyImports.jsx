...
export default function MyImports() {
  ...
  // Load imported products from localStorage on mount
  useEffect(() => {
    const savedList = JSON.parse(localStorage.getItem('Imported')) || [];
    setImportedProducts(savedList);
  }, []);

  return (
    <div className="min-h-screen bg-gray-100 py-10 px-3 sm:px-6">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-bold text-center text-green-600 mb-10">
